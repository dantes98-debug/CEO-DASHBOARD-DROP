...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      supabase.from('ventas').select('fecha, monto, moneda, tipo_cambio, monto_negro, costo, iva_pct, iva_monto, subtotal, comision_tipo, comision_valor, canal, items').or('canal.neq.ecommerce,confirmada.eq.true').gte('fecha', tresAniosAtras),
